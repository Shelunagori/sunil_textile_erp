...
class FirstTampGrnRecordsController extends AppController
{
	...
	function csvDownload()
	{
		...
		$excel = "Item Code,Quantity,Purchase Rate,Sales Rate,Addition Item Data Required, item name, hsn code, unit, gst rate fix or fluid, first gst rate, amount in refence to gst rate, second gst rate  \n";
