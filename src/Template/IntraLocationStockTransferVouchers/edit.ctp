						...
						<div class="table-responsive">
							<table id="main_table" class="table table-condensed table-bordered" style="margin-bottom: 4px;" width="100%">
								...
								<tr class="main_tr" class="tab">
									...
									<td width="25%" >
										<?php echo $this->Form->input('quantity', ['label' => false,'class' => 'form-control input-sm rightAligntextClass','placeholder'=>'Quantity','value'=>$intra_location_stock_transfer_voucher_row->quantity]); ?>
									</td>
									<td align="center">
