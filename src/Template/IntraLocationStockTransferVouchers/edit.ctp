...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $intraLocationStockTransferVoucher->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $intraLocationStockTransferVoucher->id)]
            )
        ?></li>
...
<div class="intraLocationStockTransferVouchers form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Intra Location Stock Transfer Voucher') ?></legend>
        <?php
