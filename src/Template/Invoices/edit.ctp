				...
				<td style="border-right:solid 1px;padding:5px;" width="50%" valign="top">
					<table>
						...
						<tr>
							...
							<td>&nbsp;:&nbsp;</td>
							<td><?php echo $this->Form->control('invoice_date',['label'=>false,'placeholder'=>'dd-mm-yyyy','type'=>'text','class'=>'date-picker','data-date-format'=>'dd-mm-yyyy','value'=>date('d-m-Y')]); ?></td>
						</tr>
						<tr>
							<td><b>State</b></td>
							<td>&nbsp;:&nbsp;</td>
				...
				<td style="padding:5px;" valign="top">
					<table width="100%">
						...
						<tr>
							<td><b>Name</b></td>
							<td>&nbsp;:&nbsp;</td>
							<td><?php echo $this->Form->control('party_name',['label'=>false,'placeholder'=>'Name','autofocus']); ?></td>
							<td><b>Mobile</b></td>
							<td>&nbsp;:&nbsp;</td>
			...
			<?php $i=0; foreach($invoice->invoice_rows as $invoice_row){ ?>
				<tr class="mainTr">
					<td style="text-align:center;border-left: none;">
						<span class="sr"><?php echo ++$i;  ?></span>
						<button type="button" class="btn btn-xs red viewThisResult" role="button"><i class="fa fa-times"></i></button>
					</td>
					<td>
						<?php echo $this->Form->control('item',['label'=>false,'placeholder'=>'Item Description','style'=>'width: 100%;height: 50px;resize: none;','type'=>'textarea','value'=>$invoice_row->item]); ?>
					</td>
					<td>
						<?php echo $this->Form->control('item',['label'=>false,'placeholder'=>'HSN','style'=>'width: 100%;','value'=>$invoice_row->hsn_code]); ?>
					</td>
					<td style="text-align:center;">
						<?php echo $this->Form->control('item',['label'=>false,'placeholder'=>'Quantity','style'=>'width: 100%;text-align: center;','value'=>$invoice_row->quantity]); ?>
					</td>
					<td style="text-align:right;">
						<?php echo $this->Form->control('item',['label'=>false,'placeholder'=>'Rate','style'=>'width: 100%;text-align: right;','value'=>$invoice_row->rate,'class'=>'calculate']); ?>
					</td>
					<td style="text-align:right;">
						<?php echo $this->Form->control('item',['label'=>false,'placeholder'=>'Amount','style'=>'width: 100%;text-align: right;border: none;','tabindex'=>'-1','value'=>$invoice_row->amount]); ?>
					</td>
					<td style="text-align:right;">
						<?php echo $this->Form->control('item',['label'=>false,'placeholder'=>'Rate','style'=>'width: 100%;text-align: right;','value'=>$invoice_row->discount_rate,'class'=>'revCalculate']); ?>
					</td>
					<td style="text-align:right;">
						<?php echo $this->Form->control('item',['label'=>false,'placeholder'=>'Amount','style'=>'width: 100%;text-align: right;border: none;','tabindex'=>'-1','value'=>$invoice_row->discount_amount]); ?>
					</td>
					<td style="text-align:right;">
						<?php echo $this->Form->control('item',['label'=>false,'placeholder'=>'Taxable Value','style'=>'width: 100%;text-align: right;border: none;','tabindex'=>'-1','value'=>$invoice_row->taxable_value]); ?>
					</td>
					<td style="text-align:right;">
						<?php echo $this->Form->control('item',['label'=>false,'placeholder'=>'Rate','style'=>'width: 100%;text-align: right;','value'=>$invoice_row->cgst_rate,'class'=>'revCalculate']); ?>
					</td>
					<td style="text-align:right;">
						<?php echo $this->Form->control('item',['label'=>false,'placeholder'=>'Amount','style'=>'width: 100%;text-align: right;border: none;','tabindex'=>'-1','value'=>$invoice_row->cgst_amount]); ?>
					</td>
					<td style="text-align:right;">
						<?php echo $this->Form->control('item',['label'=>false,'placeholder'=>'Rate','style'=>'width: 100%;text-align: right;','value'=>$invoice_row->sgst_rate,'class'=>'revCalculate']); ?>
					</td>
					<td style="text-align:right;">
						<?php echo $this->Form->control('item',['label'=>false,'placeholder'=>'Amount','style'=>'width: 100%;text-align: right;border: none;','tabindex'=>'-1','value'=>$invoice_row->sgst_amount]); ?>
					</td>
					<td style="text-align:right;border-right: none;">
						<?php echo $this->Form->control('item',['label'=>false,'placeholder'=>'Total','style'=>'width: 100%;text-align: right;','value'=>$invoice_row->total,'class'=>'revCalculate']); ?>
					</td>
				</tr>
			<?php } ?>
			</tbody>
			...
			<tbody>
				...
				<tr>
					...
					<td style="text-align:right;border-right: none;border-bottom: none;">
						<?php echo $this->Form->control('total_amount_after_tax',['label'=>false,'type'=>'tax','placeholder'=>'0.00','style'=>'width: 80px;border: none;text-align: right;','tabindex'=>'-1']); ?>	
					</td>
				</tr>
			</tbody>
		</table>
...
<div align="center"><?= $this->Form->button(__('Update Invoice'),['class'=>'btn green']) ?></div>
<?= $this->Form->end() ?>
...
$(document).ready(function() {
	...
	function rename_rows(){
		...
		$("#mainTbl tbody#mainTbody tr.mainTr").each(function(){
			...
			$(this).find("td:eq(1) textarea").attr({name:"invoice_rows["+i+"][item]", id:"invoice_rows-"+i+"-item"});
	...
	function calculation(){
		...
		$("#mainTbl tbody#mainTbody tr.mainTr").each(function(){
			...
			$(this).find("td:eq(13) input").val(total);
			total_amount_after_tax=total_amount_after_tax+total;
		});
		$('input[name="total_amount_before_tax"]').val(total_amount_before_tax);
		$('input[name="total_cgst"]').val(total_cgst);
		$('input[name="total_sgst"]').val(total_sgst);
		$('input[name="total_amount_after_tax"]').val(total_amount_after_tax);
	}
...
<table id="sampleTbl" style="display:none;">
	<tbody>
		<tr class="mainTr">
			...
			<td>
				<?php echo $this->Form->control('item',['label'=>false,'placeholder'=>'Item Description','style'=>'width: 100%;height: 50px;resize: none;','type'=>'textarea']); ?>
			</td>
			<td>
			...
			<td style="text-align:right;">
				<?php echo $this->Form->control('cgst_rate',['label'=>false,'placeholder'=>'%','style'=>'width: 100%;text-align: right;','class'=>'revCalculate']); ?>
			</td>
			<td style="text-align:right;">
			...
			<td style="text-align:right;">
				<?php echo $this->Form->control('sgst_rate',['label'=>false,'placeholder'=>'%','style'=>'width: 100%;text-align: right;','class'=>'revCalculate']); ?>
			</td>
			<td style="text-align:right;">
